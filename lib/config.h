...
/* Define to 1 if you have the declaration of `dn_expand', and to 0 if you
   don't. */
...
/* Define to 1 if you have the declaration of `res_search', and to 0 if you
   don't. */
...
/* Define if you have expat library */
...
/* Define if posix_fadvise() is available */
...
/* Define to libgnutls version, e.g. 0x010203 for 1.2.3 */
#define LFTP_LIBGNUTLS_VERSION_CODE 0x03040F
...
#define PACKAGE_STRING "lftp 4.6.0"
...
/* Define when using wcwidth replacement */
...
/* Define to 1 when using GNU TLS library */
#define USE_GNUTLS 1
